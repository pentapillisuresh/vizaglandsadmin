...
import { Users, UserCog, Building2, Home, TrendingUp, Clock, CheckCircle, XCircle } from "lucide-react";
                ...
                <tr key={property.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <img
                        src={property.photos?.[0] || "https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg"}
                        alt={property.title}
                        className="w-12 h-12 rounded-lg object-cover"
                      />
                      <div>
                        <p className="text-sm font-medium text-gray-900">{property.title}</p>
                        <p className="text-xs text-gray-500 capitalize">{property.propertySubtype}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 capitalize">{property.postedBy}</td>
                </tr>
              ))}
            </tbody>
          </table>
